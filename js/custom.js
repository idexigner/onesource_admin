...
function loadRequireMod(data){
   // purchaseTable();
    console.log("reached require modal")
...
function loadAvailableMod(data){
   // purchaseTable();
    console.log("reached Available modal")
   ...
   //  if(checkRoom.includes(document.getElementById("proomCheckbox"+i).value)){
    if(sroom.includes('other')){
     ...
     var sdocument='';
        ...
        for(var i =1; i<5;i++){
            // var valueId="ptypeRadio"
            if(sdocument.getElementById("sdocumentRadio"+i).checked){
...
function saleTableLoad(){
    ...
    .then((responseJson) =>{
        ...
        responseJson.map((tr)=>{
           ...
           document.getElementById("saleTable").innerHTML+= showSaleTable(tr);
...
function showSaleTable(data){
    ...
    return `
           <tr onClick="loadSaleMod(${data.s_id})">
                <td>${data.s_id}</td>
                <td>${data.sname}</td>
...
function requireTableLoad(){
    ...
    .then((responseJson) =>{
        ...
        responseJson.map((tr)=>{
           ...
           document.getElementById("requireTable").innerHTML+= showRequireTable(tr);
...
function showRequireTable(data){
    ...
    return `
           <tr onClick="loadRequireMod(${data.r_id})">
                <td>${data.r_id}</td>
                <td>${data.rname}</td>
...
function availableTableLoad(){
    ...
    .then((responseJson) =>{
        ...
        responseJson.map((tr)=>{
           ...
           document.getElementById("availableTable").innerHTML+= showAvailableTable(tr);
...
function showAvailableTable(data){
    ...
    return `
           <tr onClick="loadAvailableMod(${data.a_id})">
                <td>${data.a_id}</td>
                <td>${data.aname}</td>
